...
# Load data
#==============================================================================
#wav = siw.read('forsoeg_nopeak/skala/forsoeg_skala_hurtig.wav')
#freq = wav[0]
#data = wav[1][:-150000]
#
...
#==============================================================================
N = 2**18 # Datalængde
freq = 2**11 # Samplingsfrekvens i Hz
...
#    else:
#        return np.sin(1500*2*np.pi*x)+np.sin(1510*2*np.pi*x)
...
def sig(x):
    return np.sin(500*2*np.pi*x)+np.sin(510*2*np.pi*x)
