...
signal, noise = noise_variation(data,noise,1)
...
SIGNAL_FILT = SIGNAL                # Convolution between the filter H and the noise SIGNALx
...
X = stft(signal_filt,fftsize = 2**11,overlap = 2,beta = 5)     # STFT calculated
